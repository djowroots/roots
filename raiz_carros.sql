...
INSERT INTO `vehicles` (name, model, price, category) VALUES
	...
	('Hotring','hotring',289500,'corrida'),
	...
	('Michelli','michelli',84100,'classico'),
	...
	('Cheburek','cheburek',29300,'classico'),
	...
	('Jackal','jackal',25600,'coupes'),
	('jester 3','jester3',115800,'coupes'),
	('Sentinel','Sentinel',13500,'coupes'),
	('Sentinel 2','sentinel2',16000,'coupes'),
	('Zion','zion',13500,'coupes'),
	('Zion 2','zion2',17700,'coupes'),
	('F620','f620',28200,'coupes'),
	('Dominator3','dominator3',58600,'coupes'),
	('Oracle','oracle',5200,'coupes'),
	('Oracle 2','oracle2',9500,'coupes'),
	('Felon','felon',18300,'coupes'),
	('Fusilade','fusilade',19100,'coupes'),
	('Felon 2','felon2',21500,'coupes'),
	('Flash GT','flashgt',148500,'coupes'),
	('Exemplar','exemplar',20500,'coupes'),
	('CogCabrio','cogcabrio',32000,'coupes'),
	('Windsor','windsor',42300,'coupes'),
	('Windsor 2','windsor2',49100,'coupes'),
	('Alpha','alpha',18200,'coupes'),
	('Banshee 2','banshee2',68200,'sports'),
	('Bestia GTS','bestiagts',115000,'sports'),
	('Buffalo 2','buffalo2',128000,'sports'),
	('Carbonizzare','carbonizzare',78200,'sports'),
	('Comet 2','comet2',110500,'sports'),
	('Coquette','coquette',88300,'sports'),
	('Elegy','elegy',89500,'sports'),
	('Elegy 2','elegy2',102000,'sports'),
	('Feltzer 2','feltzer2',95800,'sports'),
	('Furore GT','furoregt',82800,'sports'),
	('Raiden','raiden',75000,'sports'),
	('Comet 5','comet5',105000,'sports'),
	('Pariah','pariah',78200,'sports'),
	('Neon','neon',125000,'sports'),
	('Jester','jester',138200,'sports'),
	('Khamelion','khamelion',100000,'sports'),
	('Kuruma','kuruma',68800,'sports'),
	('Lynx','lynx',87300,'sports'),
	('Massacro','massacro',78200,'sports'),
	('Ninef','ninef',152500,'sports'),
	('Ninef','ninef2',180600,'sports'),
	('Penumbra','penumbra',76300,'sports'),
	('Seven 70','seven70',91200,'sports'),
	('Specter 2','specter2',99900,'sports'),
	('Surano','surano',84200,'sports'),
	('Verlierer 2','verlierer2',91900,'sports'),
	('Sultan RS','sultanrs',129200,'sports'),
	('Voltic','voltic',179000,'sports'),
	('Cyclone','cyclone',315000,'super'),
	('Adder','Adder',898500,'super'),
	('Bullet','bullet',395300,'super'),
	('Cheetah','cheetah',405800,'super'),
	('EntityXF','entityxf',468200,'super'),
	('FMJ','fmj',461500,'super'),
	('Entity 2','entity2',425500,'super'),
	('Nero','nero',5120000,'super'),
	('Nero 2','nero2',1058000,'super'),
	('Osiris','osiris',389500,'super'),
	('Tezeract','tezeract',981000,'super'),
	('Taipan','taipan',859000,'super'),
	('Tyrant','tyrant',599800,'super'),
	('Penetrator','penetrator',648500,'super'),
	('Pfister 811','pfister811',521800,'super'),
	('Prototipo','prototipo',968000,'super'),
	('Reaper','reaper',689400,'super'),
	('Tempesta','tempesta',525800,'super'),
	('Vacca','vacca',398200,'super'),
	('Vagner','vagner',716900,'super'),
	('Itali GTB','italigtb',299900,'super'),
	('Itali GTB2','italigtb2',315500,'super'),
	('XA 21','xa21',598300,'super'),
	('Visione','visione',587600,'super'),
	('SC1','sc1',305200,'super'),
	('Akuma','akuma',36800,'motorcycles'),
	('Carbon RS','carbonrs',23500,'motorcycles'),
	('Esskey','esskey',15600,'motorcycles'),
	('Faggio','faggio',5500,'motorcycles'),
	('Faggio 2','faggio2',3500,'motorcycles'),
	('Faggio 3','faggio3',15000,'motorcycles'),
	...
	('Bagger','bagger',18600,'motorcycles'),
	('Chimera','chimera',54600,'motorcycles'),
	('CliffHanger','cliffhanger',39600,'motorcycles'),
	('Daemon','daemon',17900,'motorcycles'),
	('Daemon 2','daemon2',16300,'motorcycles'),
	('Hexer','hexer',25700,'motorcycles'),
	('Innovation','innovation',58000,'motorcycles'),
	('NightBlade','nightblade',62800,'motorcycles'),
	('Ratbike','ratbike',20800,'motorcycles'),
	('Sanctus','sanctus',125000,'motorcycles'),
	('Soveign','sovereign',50000,'motorcycles'),
	('Zombie A','zombiea',55000,'motorcycles'),
	('Zombie B','zombieb',61000,'motorcycles'),
	('Gargoyle','gargoyle',31600,'motorcycles'),
	('Bati','bati',27500,'motorcycles'),
	('Bati 2','bati2',40200,'motorcycles'),
	('Defiler','defiler',49500,'motorcycles'),
	('Double','double',24200,'motorcycles'),
	('Hakuchou','hakuchou',54000,'motorcycles'),
	('Hakuchou 2','hakuchou2',78200,'motorcycles'),
	('Thrust','thrust',68000,'motorcycles'),
	('Vindicator','vindicator',48200,'motorcycles'),
	('FCR','fcr',40000,'motorcycles'),
	('FCR 2','fcr2',45000,'motorcycles'),
	...
	('Benson','benson',450000,'truck'),
	('Mule','mule',337100,'truck'),
	('Mule 2','mule2',354100,'truck')
